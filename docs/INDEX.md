...
| `docs/superpowers/specs/2026-08-12-oolong-codex-partial-verdict-design.md` | Desenho da publicação do benchmark parcial e do veredito Codex CLI | Explicação |
...
| `docs/superpowers/plans/2026-08-12-publish-oolong-codex-verdict.md` | Plano para publicar o benchmark parcial, o veredito e o fork completo | How-to |
...
| `docs/decisions/0005-nao-recomendar-rlm-cli-codex-no-cenario-oolong.md` | Veredito parcial: não recomendar RLM como CLI genérica sobre Codex no OOLONG | Explicação |
